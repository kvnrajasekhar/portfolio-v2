...
const CATEGORIES = [
  {
    ...
    skills: [
      { name: "JavaScript (ES6+)", level: 0.92 },
      { name: "C#", level: 0.78 },
  ...
  },
  {
    ...
    skills: [
      { name: "React.js", level: 0.95 },
      { name: "ASP.NET MVC", level: 0.78 },
      { name: "Spring Boot", level: 0.72 },
      { name: "Material-UI", level: 0.85 },
      { name: "Bootstrap", level: 0.88 },
      { name: "Tailwind CSS", level: 0.90 },
      { name: "Framer Motion", level: 0.80 },
    ],
  },
  {
    id: "web",
    ...
    skills: [
      ...
      { name: "CSS3", level: 0.93 },
      { name: "Node.js", level: 0.88 },
      { name: "Express.js", level: 0.85 },
      { name: "RESTful API", level: 0.90 },
      { name: "JWT Auth", level: 0.82 },
    ],
  },
  {
    id: "databases",
    ...
    skills: [
      { name: "SQL Server", level: 0.85 },
      { name: "Oracle / PL-SQL", level: 0.78 },
      { name: "MongoDB", level: 0.82 },
      { name: "Mongoose", level: 0.80 },
    ],
  },
  {
    id: "tools",
    ...
    skills: [
      { name: "Git / GitHub", level: 0.93 },
      { name: "Docker", level: 0.75 },
      { name: "GitHub Actions", level: 0.72 },
      { name: "Vercel / Render", level: 0.85 },
      { name: "AWS (in progress)", level: 0.55 },
      { name: "Postman", level: 0.90 },
    ],
  },
];
