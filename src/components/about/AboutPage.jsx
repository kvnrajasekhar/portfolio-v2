    ...
    return (
      <RevealText className="my-6">
        <blockquote
          ...
          style={{
            color: isDark ? "rgba(255,255,255,0.9)" : "rgba(10,18,18,0.9)",
    ...
    return (
      <RevealText className="my-4">
        <p
          ...
          style={{
            color: isDark ? "rgba(255,255,255,0.68)" : "rgba(10,18,18,0.72)",
            fontFamily: "'Courier New', monospace",
          }}
        >
          {block.text}
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            ...
            <span
              ...
              style={{ color: isDark ? "rgba(255,255,255,0.88)" : "rgba(10,18,18,0.88)" }}
            >
              {block.title}
            </span>
          </div>
          <p
            ...
            style={{
              color: isDark ? "rgba(255,255,255,0.6)" : "rgba(10,18,18,0.65)",
              fontFamily: "'Courier New', monospace",
            }}
          >
            {block.text}
      ...
      <RevealText className="my-4">
        <div className="flex gap-4 items-start">
          ...
          <p
            ...
            style={{
              color: isDark ? "rgba(255,255,255,0.7)" : "rgba(10,18,18,0.72)",
              fontFamily: "'Courier New', monospace",
            }}
          >
            {block.text}
      ...
      <RevealText className="my-4">
        <div>
          ...
          <p
            className="text-sm leading-relaxed"
            style={{
              color: isDark ? "rgba(255,255,255,0.65)" : "rgba(10,18,18,0.68)",
              fontFamily: "'Courier New', monospace",
            }}
          >
            {block.text}
      ...
      <RevealText className="my-5">
        ...
        >
          ...
          <p
            className="text-sm leading-relaxed"
            style={{
              color: isDark ? "rgba(255,255,255,0.62)" : "rgba(10,18,18,0.68)",
              fontFamily: "'Courier New', monospace",
            }}
          >
            {block.text}
      ...
      <div className="relative w-full max-w-6xl mx-auto px-6 md:px-12 lg:px-20 grid grid-cols-1 md:grid-cols-[30%_1fr] gap-8 md:gap-20">
        ...
        >
          ...
          <h2
            ...
            style={{
              color: isDark ? "rgba(255,255,255,0.88)" : "rgba(10,18,18,0.88)",
              fontFamily: "'Courier New', monospace",
          ...
          <div
            ...
            style={{
              color: isDark ? "rgba(255,255,255,0.3)" : "rgba(10,18,18,0.35)",
              fontFamily: "'Courier New', monospace",
            }}
          >
            // {section.tag}
